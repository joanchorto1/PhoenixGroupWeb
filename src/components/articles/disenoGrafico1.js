...
import tarragona from "../img/logotipos.png"
    ...
    return (
        <Layout>
            <div className="container mt-5">
                <h1 className="text-center pb-5">El Impacto del Diseño de Logotipos en la Identidad de Marca: Construyendo una Imagen Duradera</h1>
                <p className=" pb-3">
